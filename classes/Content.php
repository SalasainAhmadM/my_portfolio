...
Class Content extends DBConnection {
	...
	public function work(){
		...
		if($save){
			$resp['status']='success';
			$resp['message']= "  On Job Training Details successfully ".$action;
			$this->settings->set_flashdata('success',$resp['message']);
	...
	public function work_delete(){
		...
		if($qry){
			$resp['status']='success';
			$resp['message']= " On Job Training Details successfully deleted";
			$this->settings->set_flashdata('success',$resp['message']);
		}
	}
	...
	public function album(){
		...
		if(empty($id)){
			$sql ="INSERT INTO album set $data";
		}else{
			$sql ="UPDATE album set $data where id = {$id}";
		}
		$save = $this->conn->query($sql);
		$action = empty($id) ? "added":"updated";
		if($save){
			$resp['status']='success';
			$resp['message']= " Album Successfully ".$action;
			$this->settings->set_flashdata('success',$resp['message']);
	...
	public function album_delete(){
		extract($_POST);
		$qry = $this->conn->query("DELETE FROM album where id = $id");
		if($qry){
			$resp['status']='success';
			$resp['message']= " Picture successfully deleted";
			$this->settings->set_flashdata('success',$resp['message']);
		}
	}
